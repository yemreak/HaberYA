...
public class NewsRepository {
    ...
    public LiveData<List<NewsWithState>> getNewsWithStateByState(State.StateType stateType) {
        return db.newsWithStateDao().getNewsWithStateByState(stateType.getId());
    }
